  ...
  return (
    <div className="fProperties">
      <div className="fPropertyItem">
        <img src="https://cf.bstatic.com/xdata/images/hotel/square600/13125860.webp?k=e148feeb802ac3d28d1391dad9e4cf1e12d9231f897d0b53ca067bde8a9d3355&o=&s=1" alt="" className="fPropertyImg"/>
        <span className="fPropertyName">Aparthotel Stare Miasto</span>
      ...
      <div className="fPropertyItem">
        ...
        />
        <span className="fPropertyName">Comfort Suites Airport</span>
      ...
      <div className="fPropertyItem">
        <img
          ...
          className="fPropertyImg"
        />
        <span className="fPropertyName">Four Seasons Hotel</span>
      ...
      <div className="fPropertyItem">
        <img
          ...
          className="fPropertyImg"
        />
        <span className="fPropertyName">Hilton Garden Inn</span>
