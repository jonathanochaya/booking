...
const SearchItem = () => {
  return (
    <div className="searchItem">
      <img className="searchItemImage" src="https://cf.bstatic.com/xdata/images/hotel/square600/261707778.webp?k=fa6b6128468ec15e81f7d076b6f2473fa3a80c255582f155cae35f9edbffdd78&o=&s=1" alt="" />
      ...
      <div className="searchItemDetails">
        ...
        <div className="searchItemDetailText">
          ...
          <span className="taxOption">Includes taxes and fees</span>
